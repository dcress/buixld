...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        cancel : $('<a>'+'<i class="fa fa-times"></i>'+options.labelCancel+'</a>').addClass("buttonCancel btn btn-danger"),
        previous : $('<a>'+'<i class="fa fa-chevron-left"></i>'+options.labelPrevious+'</a>').attr("href","#").addClass("buttonPrevious btn btn-primary"),
        next : $('<a>'+options.labelNext+'<i class="fa fa-chevron-right"></i>'+'</a>').attr("href","#").addClass("buttonNext btn btn-primary"),
        finish  : $('<a>'+options.labelFinish+'</a>').attr("type","submit").addClass("buttonFinish btn btn-primary")
    };
    ...
    var _init = function($this) {
        var elmActionBar = $('<div></div>').addClass("actionBar btn-center-wrap");
    ...
    var _showStep = function($this, stepIdx) {
        ...
        //$this.elmStepContainer.height(_step($this, selStep).outerHeight()); //was setting fixed height and cutting off content
