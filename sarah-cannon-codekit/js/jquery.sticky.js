// Edit: @dancress ~ added closeDropDowns() to toggle navigation dropdown window when passing sicky header point.
function closeDropDowns(){
	$('.navbar-right').children('.list-inline').children('li').removeClass('open');
}
            ...
            for (var f = 0; f < i.length; f++) {
                ...
                if (t <= h) {
                    if (l.currentTop !== null) {
                        ...
                        closeDropDowns(); // remove dropdowns when sticky nav is added
                        l.currentTop = null
                    }
                } else {
                    ...
                    if (l.currentTop != p) {
                        ...
                        closeDropDowns();// remove dropdowns when sticky nav is removed
                        l.currentTop = p
                    }
                }
            }
